    ...
    <c:forEach var="user" items="${users}">
        <li class="list-group-item">
            <ul class="list-group list-group-horizontal row" >
                <li class="list-group-item col-1"><h4 class="text-center">${user.getId()}</h4></li>
                <li class="list-group-item col-6"><h4>${user.getUsername()}</h4></li>
                <li class="list-group-item col-2" style="width: 8.8rem"><a class="btn btn-danger" href="/admin/${user.getId()}/delete">Delete user</a></li>
            </ul>
        </li>
    </c:forEach>
</ul>
